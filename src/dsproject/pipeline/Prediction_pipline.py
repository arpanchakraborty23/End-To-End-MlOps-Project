...
from src.dsproject.utils.utils import load_obj
...
class PredictionPipelineConfig:
    ...
    model_file_path: str = os.path.join(r"D:\MLOPS\End-To-End-MlOps-Project\artifacts\model_Trainer\model.pkl" )
    preprocessor_path: str = os.path.join(r"D:\MLOPS\End-To-End-MlOps-Project\artifacts\data_transformation\preprocess.pkl")
...
class PredictionPipeline:
    ...
    def get_predicted_dataframe(self, input_dataframe_path:pd.DataFrame):
        ...
        try:
            ...
            prediction_column_name : str = 'status'
            ...
            target_column_mapping = {'Placed':1,'Not Placed':0}
